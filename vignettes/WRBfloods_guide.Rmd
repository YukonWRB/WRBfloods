...
# file.copy(from = paste0(dirname(getwd()), "/doc/WRBfloods_guide.html"), to = "//env-fs/env-data/corp/water/Common_GW_SW/R-packages/WRBfloods/documentation/WRBfloods user guide.html", overwrite = TRUE)
```
