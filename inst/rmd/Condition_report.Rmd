  ...
  for(i in stations) {
    ...
    tryCatch ({
      ...
      if (datum_na==TRUE) {
        ...
        threedayLevel <- levelData[[2]]$Level[levelData[[2]]$Date == (Sys.Date() - 3) & levelData[[2]]$Year_Real == lubridate::year(Sys.Date())]
        ...
        tbl <- data.frame(
          ...
          `48_hr_change_cm` = (todayLevel-twodayLevel)*100,
        ...
        threedayLevel <- levelData[[2]]$Level_masl[levelData[[2]]$Date == (Sys.Date() - 3) & levelData[[2]]$Year_Real == lubridate::year(Sys.Date())]
        ...
        tbl <- data.frame(
          ...
          Two_days_ago = twodayLevel,
          `48_hr_change_cm` = (todayLevelmasl-twodayLevel)*100,
          Three_days_ago = threedayLevel,
    ...
    if (stringr::str_detect(station_info$STATION_NAME, "LAKE")==FALSE | stringr::str_detect(station_info$STATION_NAME, "RIVER")==TRUE){ #Lakes don't have flow measurements, but sometimes LAKE is mentioned when describing the river location
      ...
      tryCatch ({
        ...
        tbl <- data.frame(
          ...
          `48 hr change` = todayFlow-twodayFlow,
