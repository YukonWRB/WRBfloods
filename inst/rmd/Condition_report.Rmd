...
if (report_type %in% c("Both", "Level", "both", "level")){
  ...
  for (i in stations) {
    ...
    tryCatch ({
      ...
      #next few lines calculate where we're at for level return periods and if there's a flag raised (flag portion currently disabled)
...
if (rate == TRUE & report_type %in% c("Both", "Level", "both", "level")){
  cat("# Water levels and trajectory  \n")
